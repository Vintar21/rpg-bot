...
var Reactor = /** @class */ (function () {
                ...
                switch (_a.label) {
                    case 0:
                        if (!this.enableReactions)
                            return [2 /*return*/];
                        return [4 /*yield*/, message.react(getRandom(ACK_REACTIONS))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Reactor.prototype.failure = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, message.react(getRandom(FAILURE_REACTIONS))];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Reactor.prototype.expired = function (message) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, message.react(getRandom(EXPIRED_REACTIONS))];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
